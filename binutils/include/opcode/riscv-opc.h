...
#define MATCH_CAML 0xb
#define MASK_CAML  0x707f
#define MATCH_CAMS 0x2b
#define MASK_CAMS  0x707f
...
DECLARE_INSN(caml, MATCH_CAML, MASK_CAML)
DECLARE_INSN(cams, MATCH_CAMS, MASK_CAMS)
